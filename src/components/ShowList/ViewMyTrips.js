...
import LocationDetails from '../Search/LocationDetails/LocationDetails';
...
const ViewTrip = () => {
    ...
    const listItems = [
        { id: 1, content: "Item 1", isSelected: false },
        { id: 2, content: "Item 2", isSelected: true },
        { id: 3, content: "Item 3", isSelected: false },
        { id: 4, content: "Item 4", isSelected: false }
    ];
